...
public class BookListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button showBookButton = view.findViewById(R.id.show_book_button);
        showBookButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onShowBookButtonPressed("test");
            }
        });
    ...
    public void onShowBookButtonPressed(String title) {
        if (mListener != null) {
            mListener.onShowBook(title);
        }
    }
